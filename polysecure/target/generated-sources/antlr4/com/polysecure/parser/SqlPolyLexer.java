...
public class SqlPolyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"K_SELECT", "K_FROM", "K_WHERE", "K_JOIN", "K_ON", "K_AND", "K_OR", "K_AS", 
			"K_NULL", "K_TRUE", "K_FALSE", "K_INSERT", "K_INTO", "K_VALUES", "K_UPDATE", 
			"K_SET", "K_DELETE", "K_CREATE", "K_DROP", "K_TABLE", "K_POLYSTORE", 
			"K_STORE", "K_PRIMARY", "K_KEY", "EQ", "NEQ", "GT", "LT", "GTE", "LTE", 
			"STAR", "DOT", "COMMA", "LPAREN", "RPAREN", "SEMICOLON", "STRING_LITERAL", 
			"NUMBER", "IDENTIFIER", "WS", "A", "B", "C", "D", "E", "F", "G", "H", 
	...
	public SqlPolyLexer(CharStream input) {
		super(input);
